    ...
    <div className="min-h-screen">
      ...
      <div className="pt-16">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="container relative mx-auto px-4 py-16 sm:py-24 sm:px-6 lg:px-8 lg:py-32">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <h1 className="animate-fade-in-up mb-4 sm:mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              ...
              <p className="animate-fade-in-up mx-auto mb-6 sm:mb-8 max-w-2xl text-base sm:text-lg text-muted-foreground delay-100 px-2 sm:px-0">
        ...
        <section id="features" className="container mx-auto px-4 py-16 sm:py-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center px-4 sm:px-0">
            ...
            <p className="mb-8 sm:mb-12 text-base sm:text-lg text-muted-foreground">
        ...
        <section className="container mx-auto px-4 py-16 sm:py-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl rounded-2xl bg-primary p-6 sm:p-8 md:p-12 text-center text-primary-foreground">
          ...
          <div className="container mx-auto px-4 py-6 sm:py-8 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-between gap-3 sm:gap-4 sm:flex-row">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-base font-semibold">MineSafe</span>
              </div>
